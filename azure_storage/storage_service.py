...
app = Flask(__name__)
STORAGE_NAME = os.environ.get("STORAGE_NAME", "AZURE")
...
def download_fragment():
    ...
    # Try to find any encrypted fragment file
    found_file = None
    ...
    # Just simulate response, no need to send file
